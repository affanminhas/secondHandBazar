...
import 'schema/buyer_record.dart';
...
export 'schema/buyer_record.dart';
...
/// Functions to query BuyerRecords (as a Stream and as a Future).
Future<int> queryBuyerRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      BuyerRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<BuyerRecord>> queryBuyerRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      BuyerRecord.collection,
      BuyerRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<BuyerRecord>> queryBuyerRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<int> queryMessageListRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      MessageListRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
